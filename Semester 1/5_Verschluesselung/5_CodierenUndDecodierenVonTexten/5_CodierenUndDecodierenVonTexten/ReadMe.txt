========================================================================
    KONSOLENANWENDUNG: 5_CodierenUndDecodierenVonTexten-Projektübersicht
========================================================================

Diese 5_CodierenUndDecodierenVonTexten-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 5_CodierenUndDecodierenVonTexten-Anwendung besteht.


5_CodierenUndDecodierenVonTexten.vcxproj
...
5_CodierenUndDecodierenVonTexten.vcxproj.filters
...
5_CodierenUndDecodierenVonTexten.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 5_CodierenUndDecodierenVonTexten.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
