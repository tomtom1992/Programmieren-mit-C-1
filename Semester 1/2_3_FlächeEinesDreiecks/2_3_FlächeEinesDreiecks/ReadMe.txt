========================================================================
    KONSOLENANWENDUNG: 2_3_FlächeEinesDreiecks-Projektübersicht
========================================================================

Diese 2_3_FlächeEinesDreiecks-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 2_3_FlächeEinesDreiecks-Anwendung besteht.


2_3_FlächeEinesDreiecks.vcxproj
...
2_3_FlächeEinesDreiecks.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 2_3_FlächeEinesDreiecks.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
