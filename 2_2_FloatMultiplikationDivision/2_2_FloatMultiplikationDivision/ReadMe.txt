========================================================================
    KONSOLENANWENDUNG: 2_2_FloatMultiplikationDivision-Projektübersicht
========================================================================

Diese 2_2_FloatMultiplikationDivision-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 2_2_FloatMultiplikationDivision-Anwendung besteht.


2_2_FloatMultiplikationDivision.vcxproj
...
2_2_FloatMultiplikationDivision.vcxproj.filters
...
2_2_FloatMultiplikationDivision.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 2_2_FloatMultiplikationDivision.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
