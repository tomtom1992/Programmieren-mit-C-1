========================================================================
    KONSOLENANWENDUNG: 4_1_BuchstabenUndZiffernInEinemTextAbzaehlen-Projektübersicht
========================================================================

Diese 4_1_BuchstabenUndZiffernInEinemTextAbzaehlen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 4_1_BuchstabenUndZiffernInEinemTextAbzaehlen-Anwendung besteht.


4_1_BuchstabenUndZiffernInEinemTextAbzaehlen.vcxproj
...
4_1_BuchstabenUndZiffernInEinemTextAbzaehlen.vcxproj.filters
...
4_1_BuchstabenUndZiffernInEinemTextAbzaehlen.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 4_1_BuchstabenUndZiffernInEinemTextAbzaehlen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
