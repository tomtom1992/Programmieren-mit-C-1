========================================================================
    KONSOLENANWENDUNG: 4_2_WoerterInEinemTextAbzaehlen-Projektübersicht
========================================================================

Diese 4_2_WoerterInEinemTextAbzaehlen-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 4_2_WoerterInEinemTextAbzaehlen-Anwendung besteht.


4_2_WoerterInEinemTextAbzaehlen.vcxproj
...
4_2_WoerterInEinemTextAbzaehlen.vcxproj.filters
...
4_2_WoerterInEinemTextAbzaehlen.cpp
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 4_2_WoerterInEinemTextAbzaehlen.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
